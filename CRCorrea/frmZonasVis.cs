...
namespace CRCorrea
{ 
    public partial class frmZonasVis : Form
    {
        ...
        private void frmZonasVis_Load(object sender, EventArgs e)
        {

        }

        private void frmZonasVis_Activated(object sender, EventArgs e)
        {
            bwrZonas_Run();
        }
