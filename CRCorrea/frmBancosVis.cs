...
namespace CRCorrea
{
    public partial class frmBancosVis : Form
    {
        ...
        public void Init(String _conexaobanco,
                         String _conexaodados)
        {
        ...
        {
            if (dtBancos != null && bwrBancos.IsBusy == false)
            {
                if (clsInfo.zidincluir != 0)
                {
                    indexBancosValor = clsInfo.zidincluir;
                }
                bwrBancos.RunWorkerAsync();
            }
        ...
        private void frmBancosVis_Shown(object sender, EventArgs e)
        {
