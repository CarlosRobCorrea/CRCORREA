...
namespace CRCorrea
{
    public partial class frmCondPagtoPes : Form
    {
        ...
        private void frmCondPagtoPes_Activated(object sender, EventArgs e)
        {
            bwrCondPagto_Run();
        }

        private void frmCondPagtoPes_Shown(object sender, EventArgs e)
        {
