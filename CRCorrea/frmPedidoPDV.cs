...
namespace CRCorrea
{
    public partial class frmPedidoPDV : Form
    {
        ...
        {
            TransmiteNotaResponse respostaTransmite = null;
            using (TransactionScope tse = new TransactionScope())
            {
                ...
                //////////////////////////////
                string meioPgto = "01";
                if (rbnPix.Checked) meioPgto = "17";
                else if (rbnCartao.Checked) meioPgto = "04";
                ...
                foreach (DataRow row in dtPedido1.Rows)
                {
                    ...
                    listaItens.Add(new TransmiteNotaItem
                    {
                        ...
                        valor_total_sem_desconto = totalItem,
                        valor_desconto = "",
                        icms_origem_cstb = "0",
                        icms_csosn = 101,
                ...
                var requestTransmite = new TransmiteNotaRequest
                {
                    ...
                    Dados = new TransmiteNotaDados
                    {
                        ...
                        valor_total = clsPedidoInfo.totalmercadoria,
                        valor_total_sem_desconto = clsPedidoInfo.totalmercadoria,
                        valor_ipi = 0,
                        modalidade_frete = 0,
                ...
                respostaTransmite = APIs.EmitirNFCeTransmiteNota(strJson);
