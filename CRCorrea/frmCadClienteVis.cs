...
namespace CRCorrea
{
    public partial class frmCadClienteVis : Form
    {
        ...
        private void frmCadClienteVis_Load(object sender, EventArgs e)
        {
        ...
        public void ClienteGrid()
        {
            ...
            dtCliente = clsCadClienteBLL.GridDadosCliente(situacao, tipo);
        }
        ...
        private void bwrCliente_RunWorkerCompleted(object sender, RunWorkerCompletedEventArgs e)
        {
            try
            {
                if (e.Cancelled != true)
                {
                    ...
                    clsCadClienteBLL.GridMontaCliente(dgvCliente, dtCliente, id);
        ...
        private void tspIncluir_Click(object sender, EventArgs e)
        {
            ...
            frmCadCliente.Init(0);
            clsFormHelper.AbrirForm(this.MdiParent, frmCadCliente, clsInfo.conexaosqldados);
        ...
        private void tspExcluir_Click(object sender, EventArgs e)
        {
            try
            {
                if (dgvCliente.CurrentRow != null)
                {
                    ...
                    {
                        clsCadClienteBLL.Excluir(Int32.Parse(dgvCliente.CurrentRow.Cells["id"].Value.ToString()), clsInfo.conexaosqldados);
        ...
        {
            clsGridHelper.Filtrar(tbxPesquisa.Text, dgvCliente);
        ...
        private void frmCadClienteVis_Activated(object sender, EventArgs e)
        {
            bwrCliente_Run();
        }
