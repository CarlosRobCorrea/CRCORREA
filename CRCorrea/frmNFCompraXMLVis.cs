...
namespace CRCorrea
{
    public partial class frmNFCompraXMLVis : Form
    {
        ...
        {
            foreach (DataGridViewRow dgvXMLNFCompra in dgvXmlNFCompra.Rows)
            {
                //// Destacando itens com cores
                if (dgvXMLNFCompra.Cells["Status"].Value.ToString() == "1") // ok para transferir
                {
                    idXmlNFCompra = clsParser.Int32Parse(dgvXMLNFCompra.Cells["ID"].Value.ToString());
                    // Transferir o cabecalho da NFCompra
                    // Transferir os Itens da NFCompra
                    using (TransactionScope tse = new TransactionScope())
                    {
                        // ###############################
                        // Cadastro de XMLNFCOMPRA PARA NFCompra
                        clsXmlNFCompraInfo = new clsXmlNFCompraInfo();
                        ...
                        clsNfCompraInfo.data = clsXmlNFCompraInfo.data;
                        clsNfCompraInfo.datalanca = DateTime.Now;
                        clsNfCompraInfo.datarecebimento = clsXmlNFCompraInfo.data;
                        ...
                        clsNfCompraInfo.idfornecedor = clsXmlNFCompraInfo.idfornecedor;
                        ...
                        clsNfCompraInfo.numero = clsXmlNFCompraInfo.numero;
                        clsNfCompraInfo.observa = "";
                        clsNfCompraInfo.serie = "1";
                        clsNfCompraInfo.setor = "";
                        ...
                        clsNfCompraInfo.tipoentrada = "0";
                        clsNfCompraInfo.tipofrete = "P";
                        clsNfCompraInfo.transporte="";
                        ...
                        clsNfCompraInfo.totalmercadoria = clsXmlNFCompraInfo.totalnotafiscal;
                        clsNfCompraInfo.totalnotafiscal = clsXmlNFCompraInfo.totalnotafiscal;
                        ...
                        // Carregar os Itens da XMLNFCompra1
                        dtXmlNFCompra1 = clsXmlNFCompra1BLL.GridDados(idXmlNFCompra);
                        // Itens da NFCompra
                        foreach (DataRow row in dtXmlNFCompra1.Rows)
                        {
                            clsXmlNFCompra1Info = new clsXmlNFCompra1Info();
                            idXmlNFCompra1 = clsParser.Int32Parse(row["id"].ToString());
                            ...
                            clsNfCompra1Info.numero = clsNfCompraInfo.id;
                            clsNfCompra1Info.idcodigo = clsXmlNFCompra1Info.idcodigo;
                            clsNfCompra1Info.idipi = clsXmlNFCompra1Info.idipi;
                            clsNfCompra1Info.idunid = clsXmlNFCompra1Info.idunid;
                            clsNfCompra1Info.idunidfiscal = clsXmlNFCompra1Info.idunid;
                            clsNfCompra1Info.numero = clsNfCompraInfo.id;
                            if (clsXmlNFCompra1Info.idipi == 0)
                            {
                                id_Ipi = clsParser.Int32Parse(Procedure.PesquisaoPrimeiro(clsInfo.conexaosqldados, "SELECT ID FROM IPI where CODIGO='" + clsXmlNFCompra1Info.ncm + "' ").ToString());
                            }
                            clsNfCompra1Info.idipi = id_Ipi;
                            clsNfCompra1Info.preco = clsXmlNFCompra1Info.preco;
                            clsNfCompra1Info.qtde = clsXmlNFCompra1Info.qtde;
                            clsNfCompra1Info.qtdefiscal = clsXmlNFCompra1Info.qtde;
                            clsNfCompra1Info.tipoproduto = "00";
                            clsNfCompra1Info.totalmercado = clsXmlNFCompra1Info.totalmercado;
                            clsNfCompra1Info.totalnota = clsXmlNFCompra1Info.totalmercado;
                            clsNfCompra1Info.fatura = clsXmlNFCompra1Info.fatura;
                            clsNfCompra1Info.id = clsNfCompra1BLL.Incluir(clsNfCompra1Info, clsInfo.conexaosqldados);

                            // Atualizar a Marca+ grupo + Unidade + CODIGO DO PROD DO FORNECEDOR 
                            clsPecasBLL = new clsPecasBLL();
                            clsPecasInfo = new clsPecasInfo();
                            clsPecasInfo = clsPecasBLL.Carregar(clsNfCompra1Info.idcodigo, clsInfo.conexaosqldados);
                            clsPecasInfo.idclassifica = clsXmlNFCompra1Info.idclassifica;
                            clsPecasInfo.idmarca = clsXmlNFCompra1Info.idmarca;
                            clsPecasInfo.idunidade = clsXmlNFCompra1Info.idunid;
                            clsPecasInfo.idipi = clsXmlNFCompra1Info.idipi;
                            clsPecasInfo.codigofornecedor = clsXmlNFCompra1Info.codigofornecedor;
                            clsPecasBLL.Alterar(clsPecasInfo, clsInfo.conexaosqldados);
                            // Verificar se o Preço de Venda alterou
                            if (clsXmlNFCompra1Info.precovenda != clsXmlNFCompra1Info.precovendaanterior)
                            {
                                // Gravar o novo preço na lista de preço
                                ...
                                clsPecasPrecoInfo.valoraprazo = clsXmlNFCompra1Info.precovenda;
                                clsPecasPrecoInfo.valoravista = clsXmlNFCompra1Info.precovenda;
                                clsPecasPrecoInfo.id = clsPecasPrecoBLL.Incluir(clsPecasPrecoInfo, clsInfo.conexaosqldados);

                            }
                        }
                        // Incluir Ctas a Receber {A VISTA}
                        clsNfCompraPagarInfo = new clsNfCompraPagarInfo();
                        clsNfCompraPagarInfo.boletonro = 0;
                        clsNfCompraPagarInfo.data = clsNfCompraInfo.data;
                        clsNfCompraPagarInfo.dv = "";
                        clsNfCompraPagarInfo.id = 0;
                        clsNfCompraPagarInfo.idnota = clsNfCompraInfo.id;
                        clsNfCompraPagarInfo.idtipopaga =1;
                        clsNfCompraPagarInfo.pagou = "N";
                        clsNfCompraPagarInfo.posicao = 1;
                        clsNfCompraPagarInfo.posicaofim = 1;
                        clsNfCompraPagarInfo.valor = clsXmlNFCompraInfo.totalnotafiscal; ;
