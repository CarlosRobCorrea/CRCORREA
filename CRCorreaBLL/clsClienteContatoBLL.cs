...
{
    public class clsClienteContatoBLL : SQLFactory<clsClienteContatoInfo>
    {
        public override int Incluir(clsClienteContatoInfo info, string cnn)
        {
            VerificaInfo(info);
        ...
        public override int Alterar(clsClienteContatoInfo info, string cnn)
        {
            VerificaInfo(info);
        ...
        public void VerificaInfo(clsClienteContatoInfo info)
        {
