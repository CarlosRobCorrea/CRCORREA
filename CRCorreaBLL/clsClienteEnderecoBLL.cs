...
{
    public class clsClienteEnderecoBLL : SQLFactory<clsClienteEnderecoInfo>
    {
        public override int Incluir(clsClienteEnderecoInfo info, string cnn)
        {
            VerificaInfo(info);
        ...
        public override int Alterar(clsClienteEnderecoInfo info, string cnn)
        {
            VerificaInfo(info);
        ...
        public void VerificaInfo(clsClienteEnderecoInfo info)
        {
            if (info.cobnome == "")
            {
