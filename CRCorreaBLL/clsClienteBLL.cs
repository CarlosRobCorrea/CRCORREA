...
{
    public class clsClienteBLL : SQLFactory<clsClienteInfo>
    {
        public clsClienteInfo Carregar(String cgc, String cnn)
        {
        ...
        public clsClienteInfo CarregarNumero(Int32 numero, String cnn)
        {
            List<clsSqlFactoryValue> parametros = new List<clsSqlFactoryValue>();
        ...
        public override Int32 Incluir(clsClienteInfo info, String cnn)
        {
            VerificaInfo(info);
        ...
        public override int Alterar(clsClienteInfo info, string cnn)
        {
            VerificaInfo(info);
        ...
        public override Boolean Excluir(Int32 id, String cnn)
        {
            ...
            {
                //clsClienteprospeccaoBLL clsClienteprospeccaoBLL = new clsClienteprospeccaoBLL();
                //clsClienteprospeccaoBLL.ExcluirCliente(id, cnn);

                clsClienteContatoBLL clsClienteContatoBLL = new clsClienteContatoBLL();
                clsClienteContatoBLL.ExcluirCliente(id, cnn);

                clsClienteEnderecoBLL clsClienteEnderecoBLL = new clsClienteEnderecoBLL();
                clsClienteEnderecoBLL.ExcluirCliente(id, cnn);

                clsClienteObservaBLL clsClienteObservaBLL = new clsClienteObservaBLL();
                clsClienteObservaBLL.ExcluirCliente(cnn, id);
        ...
        public void VerificaInfo(clsClienteInfo info)
        {
            if (info.cognome == "")
            {
...
//        public Int32 SincronizarCliente(Int32 id, String cnn)
//        {
//            clsClienteprospeccaoInfo ClienteprospeccaoInfo;
//            clsClienteprospeccaoBLL Clienteprospeccao = new clsClienteprospeccaoBLL();

//            clsClienteInfo ClienteInfo;

//            // Carrega os Dados a serem transferidos
//            ClienteInfo = Carregar(id, cnn);

//            if (ClienteInfo == null)
//            {
//                throw new Exception("Registro do Cliente não foi encontrado.");
//            }

//            // Começa a Transferência
//            Int32 idprospeccao = clsParser.Int32Parse(Procedure.PesquisaoPrimeiro(cnn, "select id from clienteprospeccao where idcliente=" + ClienteInfo.id));

//            if (idprospeccao > 0)
//            {
//                ClienteprospeccaoInfo = Clienteprospeccao.Carregar(idprospeccao, cnn);
//            }
//            else
//            {
//                ClienteprospeccaoInfo = new clsClienteprospeccaoInfo();
//            }

//            ClienteprospeccaoInfo.andar = ClienteInfo.andar;
//            ClienteprospeccaoInfo.ativo = ClienteInfo.ativo;
//            ClienteprospeccaoInfo.bairro = ClienteInfo.bairro;
//            ClienteprospeccaoInfo.cadastrado = ClienteInfo.cadastrado;
//            ClienteprospeccaoInfo.cep = ClienteInfo.cep;
//            ClienteprospeccaoInfo.cgc = ClienteInfo.cgc;
//            //ClienteprospeccaoInfo.cidade = ClienteInfo.cidade;
////            ClienteprospeccaoInfo.clientedesde = ClienteInfo.clientedesde;
//            ClienteprospeccaoInfo.codigocliente = ClienteInfo.codigocliente;
//            ClienteprospeccaoInfo.cognome = ClienteInfo.cognome;
//            ClienteprospeccaoInfo.comple = ClienteInfo.comple;
//            ClienteprospeccaoInfo.contato = ClienteInfo.contato;
//            //ClienteprospeccaoInfo.datanasc = ClienteInfo.datanasc;
//            ClienteprospeccaoInfo.ddd = ClienteInfo.ddd;
//            ClienteprospeccaoInfo.email = ClienteInfo.email;
//            ClienteprospeccaoInfo.endereco = ClienteInfo.endereco;
//            ClienteprospeccaoInfo.endtipo = ClienteInfo.endtipo;
//            ClienteprospeccaoInfo.ftp = ClienteInfo.ftp;
//            ClienteprospeccaoInfo.homepage = ClienteInfo.homepage;
//            ClienteprospeccaoInfo.ibge = ClienteInfo.ibge;
//            ClienteprospeccaoInfo.idcliente = ClienteInfo.id;
//            ClienteprospeccaoInfo.idcidade = ClienteInfo.idcidade;
//            ClienteprospeccaoInfo.idestado = ClienteInfo.idestado;
//            //ClienteprospeccaoInfo.idgrupo = ;
//            ClienteprospeccaoInfo.idramo = ClienteInfo.idramo;
//            ClienteprospeccaoInfo.idregimeapuracao = ClienteInfo.idregimeapuracao;
//            ClienteprospeccaoInfo.idvendedor = ClienteInfo.idvendedor;
//            ClienteprospeccaoInfo.idzona = ClienteInfo.idzona;
//            ClienteprospeccaoInfo.ie = ClienteInfo.ie;
//            ClienteprospeccaoInfo.imunicipal = ClienteInfo.imunicipal;
//            ClienteprospeccaoInfo.nome = ClienteInfo.nome;
//            ClienteprospeccaoInfo.numero = clsParser.Int32Parse(Procedure.PesquisaoPrimeiro(cnn, "SELECT top 1 MAX(NUMERO) + 1 FROM CLIENTEPROSPECCAO group by NUMERO ORDER BY NUMERO DESC"));
//            //ClienteprospeccaoInfo.numero = ClienteInfo.numero;
//            ClienteprospeccaoInfo.numeroend = ClienteInfo.numeroend;
//            ClienteprospeccaoInfo.pessoa = ClienteInfo.pessoa;
//            ClienteprospeccaoInfo.regiao = ClienteInfo.regiao;
//            ClienteprospeccaoInfo.telefone = ClienteInfo.telefone;
//            ClienteprospeccaoInfo.tipo = ClienteInfo.tipo;
//            ClienteprospeccaoInfo.tipocomple = ClienteInfo.tipocomple;
//            ClienteprospeccaoInfo.tiponumero = ClienteInfo.tiponumero;

//            if (ClienteprospeccaoInfo.id != 0)
//            {
//                Clienteprospeccao.Alterar(ClienteprospeccaoInfo, cnn);
//            }
//            else
//            {
//                ClienteprospeccaoInfo.id = Clienteprospeccao.Incluir(ClienteprospeccaoInfo, cnn);
//            }

//            return ClienteprospeccaoInfo.id;
//        }
